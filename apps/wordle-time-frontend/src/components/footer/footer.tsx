            ...
            <div class="px-4 mx-auto max-w-8xl lg:px-4">
                <div class="grid gap-12 lg:grid-cols-5 lg:gap-18">
                    ...
                    <div>
                        ...
                        <ul>
                            <li class="mb-4">
                                <a href="https://discord.gg/PRyZGKPB" rel="noreferrer nofollow" class="font-medium  text-ctp-blue hover:underline">
                                    Discord</a>
                            </li>
                            <li class="mb-4">
                                <a href="https://github.com/wordle-time/" rel="noreferrer nofollow" class="font-medium  text-ctp-blue hover:underline">
                                    Github</a>
                            </li>
                ...
                <span class="block font-normal text-center ">
