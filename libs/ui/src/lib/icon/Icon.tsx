  ...
  return (
    ...
    >
      <g fill="none" stroke="currentColor" strokeWidth="1.5">
        ...
        <path d="M39.6492 40.7967V58.1013H22.5048V40.7167L39.6492 40.7967Z" fill="#6AAA64" />
        <path d="M39.8894 21.5405L39.7993 39.4856L21.8743 39.3855L21.9543 21.4705L39.8894 21.5405Z" fill="#D1B036" />
        <path d="M38.8384 3.8457L38.7684 19.629L22.9651 19.5689V3.8457H38.8384Z" fill="white" />
        <path d="M21.2437 40.6266V58.1913H7.41209C5.35036 58.1913 3.66895 56.5099 3.66895 54.4482V40.6266H21.2437Z" fill="#6AAA64" />
        <path d="M19.9526 22.6515L19.8725 38.4347H4.03918V22.6515H19.9526Z" fill="white" />
        <path d="M19.9626 3.8457V19.649H4.03918V7.22855C4.03918 5.36698 5.56046 3.8457 7.43203 3.8457H19.9626Z" fill="white" />
        <path
